...
DEFAULT_QUEUE_DIR = Path("/Users/busiji/workbot/workspace/artifacts/tmux-runtime/delivery-queue")
DEFAULT_RECEIPTS_LOG = Path(
    "/Users/busiji/workbot/workspace/artifacts/tmux-runtime/window-ipc-delivery-receipts.jsonl"
)
DEFAULT_STDOUT_LOG = Path(
    "/Users/busiji/workbot/workspace/artifacts/tmux-runtime/tmux-handoff-window-ipc-bridge.stdout.log"
)
DEFAULT_PID_FILE = Path(
    "/Users/busiji/workbot/workspace/artifacts/tmux-runtime/tmux-handoff-window-ipc-bridge.pid"
)
DEFAULT_LOCK_FILE = Path(
    "/Users/busiji/workbot/workspace/artifacts/tmux-runtime/tmux-handoff-window-ipc-bridge.lock"
)
...
def bundle_message(bundle: dict[str, Any]) -> str:
    notification = bundle.get("tmux_runtime_handoff", {}).get("notification", {})
...
class CodexWindowIpcClient:
    ...
    def ensure_connected(self) -> None:
        ...
        if os.name == "nt":
            raise WindowIpcError("Windows named-pipe Codex IPC is not supported by tmux-runtime")
