...
# ==============================================================================
# Reason: Switched to JSONL mechanism
# Alternative: None (functionality simplified)
...
enforce_via_scheduler("write_tmux_notifications_sqlite.py")
# ==============================================================================
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Write tmux-runtime handoff notification records into a local SQLite database."
    )
    parser.add_argument(
        "--db-file",
        default="/Users/busiji/workbot/workspace/artifacts/tmux-runtime/handoff-notifications.sqlite3",
