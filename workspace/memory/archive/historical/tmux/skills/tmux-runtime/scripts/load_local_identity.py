...
"""Deprecated compatibility stub for removed tmux-runtime pane-session loading."""
...
def main() -> int:
    raise SystemExit(
        "load_local_identity.py is deprecated: tmux-runtime no longer manages pane-session bootstrap loading. "
