...
# ==============================================================================
# Reason: Switched to unified event format
# Alternative: None (functionality integrated)
...
enforce_via_scheduler("tmux_notification_record.py")
# ==============================================================================
...
def build_db_record(event: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "source": event.get("source", "tmux-runtime"),
    }
