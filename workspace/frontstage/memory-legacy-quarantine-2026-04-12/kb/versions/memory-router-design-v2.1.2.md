...
>
> 下方出现的 `Canonical`、`唯一真相声明` 等表述均为历史原文保留；当前权威归属与路由裁决以 [workspace/project-map/INDEX.md](/Users/busiji/workbot/workspace/project-map/INDEX.md) 和 [workspace/memory/kb/global/INDEX.md](/Users/busiji/workbot/workspace/memory/kb/global/INDEX.md) 的现行 formal canonical 记录为准。

# 记忆分层路由总设计 v2.1.2（Historical Upstream Canonical）

> ⚠️ **上游历史版本声明**
> 本文档保留的是上游 v2.1.2 版本的自我定义；若与当前 `workbot` 本地 formal canonical 冲突，以当前本地 canonical 和地图裁决为准。
