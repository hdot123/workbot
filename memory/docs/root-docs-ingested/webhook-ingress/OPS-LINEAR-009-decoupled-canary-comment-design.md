...
| # | File | Purpose |
|---|------|---------|
| 1 | `tools/webhook_ingress/actions.py` | `Action`, `ActionGuard`, `ActionResult`, `ActionRegistry`, `LinearCanaryCommentAction` |
| 2 | `tools/webhook_ingress/executors.py` | `LinearCanaryCommentExecutor`, `LinearCanaryCommentResult` |
| 3 | `tools/webhook_ingress/tests/test_actions.py` | Unit tests for executor, action, registry |
