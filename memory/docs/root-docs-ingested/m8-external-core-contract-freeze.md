...
1. `tools/memory_hook_interfaces.py`
2. `tools/memory_hook_core.py::build_context_package_core(...)`
3. `tools/memory_hook_gateway.py::build_context_package(...)`
4. `tools/memory_hook_provider_rollback.py::run_rollback_drill()`
...
`tools/memory_hook_provider_rollback.py` pass criteria are frozen as:
