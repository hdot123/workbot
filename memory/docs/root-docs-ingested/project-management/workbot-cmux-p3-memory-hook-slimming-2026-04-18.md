...
- 在 `/Users/busiji/workbot/tools/memory_hook_impls.py` 的 `ArtifactSinkImpl` 内新增 shared-payload 写入逻辑。
...
- 构造回归样本:
  ...
  - delta: `409`
- 真实完整样本基线:
  - 样本来源: `/Users/busiji/workbot/artifacts/memory-hook/contexts/latest-codex-stop.json`
  - raw package: `3790`
...
python3 -m py_compile /Users/busiji/workbot/tools/memory_hook_impls.py /Users/busiji/workbot/tests/test_memory_hook_shared_payload_artifacts.py
```
