...
- 新增 commander summary schema/helper:
  - `/Users/busiji/workbot/tools/cmux_summary_artifact.py`
- 更新 `cross_verify` 输出双轨 artifact:
  - 短摘要: `/Users/busiji/workbot/artifacts/cmux-runtime/cross-verify-summary-latest.json`
  - 详细 sidecar: `/Users/busiji/workbot/artifacts/cmux-runtime/cross-verify-latest.json`
- 新增测试:
