#!/usr/bin/env python3
"""Phase-1 tmux environment setup for tmux-runtime."""
...
enforce_orchestrator_only("init_tmux_env.py")
# ==============================================================================
...
def require_visible_terminal_launcher(snapshot: dict[str, Any], formal_session: str) -> dict[str, Any]:
    ...
    if current_client.get("inside_tmux"):
        raise RuntimeError(
            "new tmux-runtime tasks must start from a fresh visible terminal, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create or normalize the tmux environment for tmux-runtime.")
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Create a new formal session for a fresh tmux-runtime task startup.",
    )
    parser.add_argument(
