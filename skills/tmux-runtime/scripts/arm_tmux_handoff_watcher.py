#!/usr/bin/env python3
"""Arm the tmux-runtime handoff watcher for the current formal runtime targets."""
...
DEFAULT_LOG_FILE = Path("/Users/busiji/workbot/workspace/artifacts/tmux-runtime/handoff-notifications.jsonl")
DEFAULT_STDOUT_LOG = Path("/Users/busiji/workbot/workspace/artifacts/tmux-runtime/watch-tmux-handoff.stdout.log")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Arm the internal tmux-runtime watcher for the formal runtime targets."
    )
    parser.add_argument(
        "--formal-session-name",
