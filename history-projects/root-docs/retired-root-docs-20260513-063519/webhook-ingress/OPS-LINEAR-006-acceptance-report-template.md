...
| 文件名 | 内容 | 存放位置 |
|--------|------|---------|
| `evidence/health-check.json` | Health endpoint 响应 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/dt01-backward-compat.txt` | DT-01 curl 输出 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/dt02-shadow-accepted.json` | DT-02 响应体 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/supabase-three-tables.txt` | SQL-DT03 三表查询结果 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/dt04-n8n-canonical.json` | DT-04 n8n execution 输入 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/linear-issue-info.json` | 创建的临时 Issue 信息 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/idempotency-sql.txt` | 幂等 SQL 验证结果 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/redaction-check.txt` | 脱敏验证结果 | `workspace/memory/evidence/OPS-LINEAR-006/` |
| `evidence/no-production-actions.txt` | 生产隔离验证结果 | `workspace/memory/evidence/OPS-LINEAR-006/` |
