...
| File | Additions |
|------|-----------|
| `workspace/tools/webhook_ingress/executors.py` | `FactoryDispatchDryRunResult`, `FactoryDispatchDryRunExecutor` |
| `workspace/tools/webhook_ingress/actions.py` | `FactoryDispatchDryRunAction`, `_extract_project_id`, `_extract_state`, `_log_dryrun` |
| `workspace/tools/webhook_ingress/server.py` | Config fields, wiring in `_build_ingress()` |
| `workspace/tools/webhook_ingress/__init__.py` | Export new classes |
...
| File | Purpose |
|------|---------|
| `workspace/tools/webhook_ingress/executors.py` | Keep existing `LinearCanaryComment*` |
| `workspace/tools/webhook_ingress/executors/dryrun.py` | `FactoryDispatchDryRunResult`, `FactoryDispatchDryRunExecutor` |
| `workspace/tools/webhook_ingress/actions.py` | Keep existing `LinearCanaryCommentAction` |
| `workspace/tools/webhook_ingress/actions/dryrun.py` | `FactoryDispatchDryRunAction` |
